...
Rabeprazole is a proton pump inhibitor (PPI) class drug, pharmacologically established for acid-peptic disorders (duodenal/gastric ulcer, GERD, *H. pylori* eradication regimens).
The TxGNN model assigns a high statistical score to **Smouldering Systemic Mastocytosis** as a candidate new indication,
but currently **no clinical trials and no publications** support this specific direction, and the evidence pack itself notes no known mechanistic link.
